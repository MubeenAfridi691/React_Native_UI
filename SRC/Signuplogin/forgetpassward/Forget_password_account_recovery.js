...
const Forget_password_account_recovery = ({navigation}) => {
  return (
...
<Text style={{color:'white',fontSize:20}}>Account Recovered Successfully</Text>
</Text>
</View>

    
    <TouchableOpacity style={{marginBottom:20,height:50,width:300,backgroundColor:'black',borderRadius:10,marginTop:20,padding:10,fontSize:20,color:'white',borderWidth:1,borderBlockColor:'white'}} onPress={()=>navigation.navigate('login')}>
...
export default Forget_password_account_recovery
